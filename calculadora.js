...
function calculator(button) {
    ...
    if (button.type == "operator") {
        ...
        //Resolve problema de potência e fatorial
        let POWER_SEARCH_RESULT = search(data.formula, POWER)
        let FACTORIAL_SEARCH_RESULT = search(data.formula, FACTORIAL)

        /* Pega a base da potência E corrige a fórmula para o IDE*/
        ...
        /* Pega o número fatorial E corrige a fórmula para o IDE */
...
/* Acha a base da potência */
function powerBaseGetter(formula, POWER_SEARCH_RESULT) {
    let power_bases = [] //Salva as bases encontradas
...
/* Acha o número fatorial */
function factorialNumberGetter (formula, FACTORIAL_SEARCH_RESULT) {
    let numbers = [] //salva os números encontrados
    ...
    FACTORIAL_SEARCH_RESULT.forEach (factorial_index => {
        ...
        //Caso haja uma sequência de fatorial
...
/* Procurar fatorial e/ou potência */
